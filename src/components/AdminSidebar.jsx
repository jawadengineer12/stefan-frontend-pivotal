        ...
        {sidebarVisible && (
          <>
            <div className="flex flex-col space-y-4 mt-8">
              <h1 className="font-['Montserrat'] text-xl font-bold">Admin Dashboard</h1>
               <button
                onClick={() => handleNavClick("/admin/dashboard/company")}
                className="font-['Readex'] text-left hover:bg-[#7292af] px-4 py-2 rounded cursor-pointer"
              >
                Manage Companies
              </button>
              <button
            ...
            <button
              ...
              className="font-['Readex'] w-full bg-[#C40000] hover:bg-[#c40101c9] text-white mt-6 px-4 py-2 rounded cursor-pointer"
            >
              Logout
            </button>
          </>
